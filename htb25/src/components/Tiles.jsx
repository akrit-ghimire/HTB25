...
const Tiles = ({
  ...
  return (
    <div className="h-full overflow-scroll w-1/2">
      <div className="h-screen overflow-scroll bg-light_c rounded-tl-3xl rounded-bl-3xl p-6 gap-3 flex flex-col">
        <div className="bg-light rounded-3xl px-6 py-6">
          <p className="font-bold">{name} Summary</p>
          <p>{summary}</p>
        </div>
        <div className="rounded-3xl overflow-hidden bg-light h-auto">
          {children}
        </div>
